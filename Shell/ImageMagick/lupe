#!/bin/bash
#
# Developed by Fred Weinhaus 3/19/2008 .......... revised 11/28/2011
#
...
tmp0="$dir/lupe_0_$$.png"
tmp1="$dir/lupe_1_$$.png"
tmp2="$dir/lupe_2_$$.png"
...
convert -size ${ws}x${hs} xc:black -fill white \
	-draw "$shape1 $xc,$yc $lenx,$leny 0,360" $tmp0
...
if [ "$distort" = "0" ]
	...
	convert $tmpA[$sub] -distort SRT "$xc,$yc  $mag  0" $tmp1
...
echo "fx"
	convert $tmpA[$sub] -matte -channel RGBA -virtual-pixel transparent -monitor -fx \
...
convert $tmpA \( $tmp1 $tmp0 $tmp0 -compose multiply -composite \) \
