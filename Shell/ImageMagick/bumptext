#!/bin/bash
#
# Developed by Fred Weinhaus 1/7/2010 .......... revised 11/26/2011
# 
...
convert -quiet -regard-warnings "$infile" -alpha off +repage $colorization "$tmpA1" ||
...
grayval=`convert $tmpA2[1x1+0+0] -format "%[fx:100*u.r]" info:`
