(function() {
	...
	Element.Frame = function(content) {
		...
		var close_button = contentEl.insert({
			...
			text: 'X',
			title: 'Close',
			style: ['background:#333', 'border:2px solid #6a6a6a', 'border-radius:50%', 'box-shadow:0 -12px 14px -10px #1f1f1f inset,0 0 2px #333', 'color:#ddd', 'font:bold 12px/22px Verdana,sans-serif', 'height:22px', 'margin:0', 'padding:0', 'opacity:1', 'position:absolute', 'top:-14px', 'left:-14px', 'text-align:center', 'text-decoration:none', 'text-shadow:0 -1px 0 #000', 'width:22px', 'z-index:1000'].join(";")
		});
