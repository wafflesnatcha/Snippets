(function() {
	...
	var smushit = {
		...
		post: function() {
			...
			html = '<form method="post" id="smushit-post-form" action="' + posturl + '">' + '<input type="hidden" name="img" value="' + imgs.join('\n') + '">' + '</form>';
